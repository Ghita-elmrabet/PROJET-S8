...
function [A]=aire_trapz_fft(f1,f2,signal) % pour f1 et f2 fixees, plus k est grand plus l'intervalle entre les 2 points                                        %est petit plus la pr??cision du calcul est ??lev??e
