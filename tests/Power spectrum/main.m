...
%% approche LPC
 dsp1=LPC(f,p_ar,sigma,p,Fe); %ne pas oublier de mettre Fe à  1 si on travaille en frequences normalisées
...
PW2=aire_rec(f,dsp1,0,Fe-Fe/N);
PW3=aire_rec(f,dsp2,0,Fe-Fe/N);
